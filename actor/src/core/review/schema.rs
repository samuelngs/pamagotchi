                ...
                "social_relations": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "source_kind": { "type": "string", "enum": ["inferred", "stated", "owner_confirmed", "import", "system"] },
                    ...
                    "items": {
                        ...
                        "properties": {
                            "scope": {
                                ...
                                "description": "Where the norm applies. Non-owner review may write only the current person or current group."
                            },
                            "group_id": { "type": "string" },
                            "person_id": { "type": "string" },
                            "authority": { "type": "string", "enum": ["owner", "trusted", "default", "restricted", "blocked"] },
                            "directive": {
                                "type": "string",
