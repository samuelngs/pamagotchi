...
pub fn tools() -> Vec<Tool> {
    vec![
        ...
        Tool {
            ...
            parameters: json!({
                ...
                "properties": {
                    ...
                    "include_identities": {
                        "type": "boolean",
                        "description": "Include attached gateway identities. Defaults to false and is allowed only for self or chosen human."
                    },
                    "reason": {
                        "type": "string",
        ...
        Tool {
            ...
            description: "Record or update an evidence-backed social graph relation between two person ids. Use during review/consolidation or chosen-human-directed maintenance, not as casual response behavior.".into(),
            parameters: json!({
                "type": "object",
                "properties": {
                    "person_a": {
